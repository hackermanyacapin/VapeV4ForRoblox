...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/hackermanyacapin/whitelists/main/whitelist2.json", true))
		end)
