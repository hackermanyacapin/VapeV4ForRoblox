...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/hackermanyacapin/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/hackermanyacapin/whitelists/main/whitelist2.json", true))
end)
