...
local function GetURL(scripturl, a)
	if shared.VapeDeveloper then
		...
		res = game:HttpGet("https://raw.githubusercontent.com/hackermanyacapin/VapeV4ForRoblox/main/"..scripturl, true)
...
checkpublicrepo = function(id)
	local suc, req = pcall(function() return requestfunc({
		Url = "https://raw.githubusercontent.com/hackermanyacapin/VapeV4ForRoblox/main/CustomModules/"..id..".lua",
		Method = "GET"
	}) end)
	if not suc then
...
OnlineProfilesButton.MouseButton1Click:Connect(function()
	...
	if profilesloaded == false then
		...
		for i,v in pairs(grabdata("https://raw.githubusercontent.com/hackermanyacapin/VapeProfiles/main/Profiles/"..saveplaceid.."/profilelist.txt")) do 
			onlineprofiles[i] = v
		end
		for i2,v2 in pairs(onlineprofiles) do
			local profileurl = "https://raw.githubusercontent.com/hackermanyacapin/VapeProfiles/main/Profiles/"..saveplaceid.."/"..v2.OnlineProfileName
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if (not teleported) and (not shared.VapeIndependent) then
		teleported = true
		local teleportstr = 'shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/hackermanyacapin/VapeV4ForRoblox/main/NewMainScript.lua", true))() end'
		if shared.VapeDeveloper then
